...
<form action="syallabus_insert.php"  id="formID"method="post" enctype="multipart/form-data" name="form1">
  <table width="403" height="280" border="0" align="center">
    <tr>
      <td>Syallabus Name</td>
      <td><input name="syallabusname" type="text" id="syallabusname" class="validate[required,custom[onlyLetter]] form-control"></td>
    </tr>
    <tr>
      <td>Course Name </td>
    ...
    <tr>
      ...
      <td><input name="syacopyatta" type="file" id="syacopyatta" required form-control></td>
    </tr>
    <tr>
